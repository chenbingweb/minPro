...
class NSServerList {
    ...
    OnLoadServerListSuccess(xmldata) {
        ...
        this.AccountSvrList = []; //账号服务器列表
        this.WorldSvrList = [];//世界服务器
        this.GameSvrList = [];//游戏服务器
        this.ArticleSvrList = [];//文章服务器
...
/*
        ...
        if(this.ArticleSvrList.length>0)
        {
            console.log("imgurl",this.ArticleSvrList[0])
        }
      console.log('AccountSvrList',this.AccountSvrList) 
      console.log('GameSvrList', this.GameSvrList ) 
      console.log('ArticleSvrList',this.ArticleSvrList ) 
