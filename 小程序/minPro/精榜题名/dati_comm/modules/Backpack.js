...
class _Backpack
{
    ...
    get AD() {
        ...
        console.log("strArraystrArray", strArray)
        var re = []
    ...
    get ADClick(){
        ...
        var re = 0
        var strArray = this.SyncObj.GetValue("ADClick").split(';')
        for(var i=0;i<strArray.length;i++)
           re+=parseInt(strArray[i])  
    ...
    {
        if (this.SyncObj == null) return 0;
        var clickArray = this.SyncObj.GetValue("ADClick").split(';')
 
        console.log("GetADClickNum", clickArray)
 
        var adarray = this.AD
        console.log("aaa", adarray)
        for(var i=0;i<adarray.length;i++)
        {
            if(adarray[i]==id) return parseInt(clickArray[i])
        }
        return 0
    }
