...
//require("../../utils/job.js").data;
let jobData = !getApp().globalData.jobList ? require("../../utils/job.js").data:getApp().globalData.jobList 
Component({
  /**
   * 组件的属性列表
   */
  ...
  ready(){
    jobData = getApp().globalData.jobList;
    this.setData({
      one: jobData,
  ...
  methods: {
    ...
    bindChange: function ({ detail }) {
      ...
      let three = two[value[1]] ? two[value[1]].subLevelModelList:[]
